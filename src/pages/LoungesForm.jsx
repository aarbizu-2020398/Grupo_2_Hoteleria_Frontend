...
import LoungeList from '../components/Lounges/loungeList';
import LoungeForm from '../components/Lounges/loungesForm';
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-[#034a8a]">Gestión de Salones</h1>
          <button
        ...
        <div className="bg-white shadow overflow-hidden rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">Salones Disponibles</h2>
            <button
